...
public class DataUtils
{
    ...
    public static UUID bytesToUUID(final ByteBuffer bytes)
    {
        if (null == bytes)
        {
            return null;
    ...
    public static String objectToJson(final Object obj)
    {
        ...
        {
            throw new IllegalArgumentException("Unable to convert item to json.", e);
        }
    }
    ...
    public static <T> T jsonToObject(final String json, final Class<T> clazz)
    {
        ...
        {
            throw new IllegalArgumentException("Unable to build item from json.", e);
        }
    }
