...
/**
 * Core api for manipulating graph nodes.
 */
public interface Node<T> {
    /**
     * delete this node from model
     */
    void delete() throws NormandraException;

    /**
     * update the node entity with given instance, which saves to model
     *
     * @param entity
    ...
    /**
     * determine if connected edge exists between this node and target node
     *
     ...
     */
    int getDegree() throws NormandraException;
     ...
     *
     * @param edgeType edge entity type
     * @param nodeType neighbor node entity type
     */
    <E, N> Iterable<Node<N>> getNeighbors(final Class<E> edgeType, final Class<N> nodeType) throws NormandraException;
     ...
     * @param edgeType the edge entity type to filter
     * @return
     * @throws NormandraException
     */
     ...
     *
     * @param depth     the depth to search
     * @param edgeTypes the edge entity type to filter
     * @return
     * @throws NormandraException
     */
    default <E, N> Iterable<Node<N>> expandByTypes(int depth, Class<E>... edgeTypes) throws NormandraException {
        ...
        return this.expandByTypes(depth, Arrays.asList(edgeTypes));
    }
     ...
     *
     * @param type the edge entity type
     */
    <E> Iterable<Edge<E>> getEdgesByType(Class<E> type) throws NormandraException;
    ...
    default <E> Iterable<Edge<E>> getEdgesByTypes(final Class<E>... types) throws NormandraException {
        ...
        return this.getEdgesByTypes(Arrays.asList(types));
    }
