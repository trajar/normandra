...
public class CassandraDataHandler implements DataHandler
{
    ...
    public boolean save(final EntityMeta entity, final Map<ColumnMeta, Object> data)
    {
        ...
        Insert statement = QueryBuilder.insertInto(keyspaceName, entity.getTable());
        for (final Map.Entry<ColumnMeta, Object> entry : data.entrySet())
        {
            ...
            else
            {
                ...
                Delete delete = QueryBuilder.delete(column.getName()).from(keyspaceName, entity.getTable());
                for (final ColumnMeta key : entity.getPrimaryKeys())
                {
