...
abstract public class GraphTest extends BaseTest {
    ...
    public void testSave() throws Exception {
        ...
        Assert.assertNotNull(likesEdge);
        Assert.assertEquals(1, fooNode.getDegree());
        Assert.assertEquals(1, barNode.getDegree());
        final Edge hatesEdge = barNode.createEdge(fooNode, hates);
        Assert.assertNotNull(hatesEdge);
    ...
    public void testNeighbors() throws Exception {
        ...
        for (final Object node : john.getEdgesByType(SimpleEdge.class)) {
            edges.add(node);
        }
        ...
        for (final Object node : john.getNeighbors()) {
            nodes.add(node);
        }
        Assert.assertFalse(nodes.isEmpty());
        Assert.assertEquals(2, nodes.size());
        ...
        nodes = new ArrayList();
        for (final Object node : mike.getNeighbors(null, SimpleNode.class)) {
            nodes.add(node);
        }
        Assert.assertFalse(nodes.isEmpty());
        ...
        nodes = new ArrayList();
        for (final Object node : mike.getNeighbors(SimpleEdge.class, SimpleNode.class)) {
            nodes.add(node);
        }
        Assert.assertFalse(nodes.isEmpty());
        Assert.assertEquals(2, nodes.size());
        ...
        nodes = new ArrayList();
        for (final Object node : mike.getNeighbors(SimpleEdge2.class, SimpleNode.class)) {
            nodes.add(node);
        }
        Assert.assertFalse(nodes.isEmpty());
    ...
    public void testExpand() throws Exception {
        ...
        Collection nodes = new ArrayList();
        for (final Object node : john.expand(1)) {
            nodes.add(node);
        }
        Assert.assertFalse(nodes.isEmpty());
        Assert.assertEquals(1, nodes.size());
        Assert.assertEquals(bob.getEntity(), ((Node) nodes.iterator().next()).getEntity());

        nodes.clear();
        for (final Object node : bob.expand(1)) {
            nodes.add(node);
        }
        Assert.assertEquals(2, nodes.size());

        nodes.clear();
        for (final Object node : john.expand(2)) {
            nodes.add(node);
        }
        Assert.assertEquals(2, nodes.size());
